      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 bg-white overflow-y-auto">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                type="email"
                required
                className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg bg-white text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-gray-900 transition-all min-h-[48px]"
            ...
            <div className="flex items-center">
              <input
                ...
                className="w-3.5 h-3.5 border border-gray-300 rounded text-gray-900 focus:ring-1 focus:ring-gray-900 focus:ring-offset-0 cursor-pointer transition-all"
              />
              <label htmlFor="remember" className="ml-2 text-xs text-gray-700 cursor-pointer select-none">
                Lembrar de mim
              </label>
            </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-gray-900 text-white py-3 rounded-lg font-semibold hover:bg-gray-800 transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed min-h-[48px] flex items-center justify-center"
            >
              {isLoading ? (
          ...
          <div className="space-y-2.5">
            <button className="w-full flex items-center justify-center gap-3 px-4 py-3 border-2 border-gray-300 rounded-lg font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-400 transition-all text-sm min-h-[48px]">
