...
import { Search, X, ChevronRight, ChevronLeft, FilePlus2 } from "lucide-react"
import { pageTemplates, type PageTemplate } from "../constants/pageTemplates"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-4">
                    {filteredTemplates.map((template) => {
                      ...
                      return (
                        ...
                        >
                          {/* Ícone */}
                          <div className="flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 mb-3 rounded-xl bg-white/50 dark:bg-slate-800/50">
              ...
              {selectedTemplateData && (
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className="w-16 h-16 rounded-xl bg-white/50 dark:bg-slate-800/50 flex items-center justify-center flex-shrink-0">
                      {(() => {
                        const Icon = selectedTemplateData.iconComponent
