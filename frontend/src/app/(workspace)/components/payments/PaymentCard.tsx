...
const PaymentCard: React.FC<Props> = ({ brand = "CARD", last4, expMonth, expYear, name }) => {
  ...
  return (
    <StyledWrapper>
      <div className="flip-card" aria-label={`Cartão ${brandText} terminado em ${last4}`}>
        <div className="flip-card-inner">
          <div className="flip-card-front">
            <p className="heading_8264">{brandText}</p>
            ...
            <svg version="1.1" className="chip" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30px" height="30px" viewBox="0 0 50 50" xmlSpace="preserve">
            ...
            <svg version="1.1" className="contactless" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20px" height="20px" viewBox="0 0 50 50" xmlSpace="preserve">
            ...
            <p className="number">{masked}</p>
            <p className="valid_thru">VALID THRU</p>
            <p className="date_8264">{mm} / {yy}</p>
...
const StyledWrapper = styled.div`
  ...
  .flip-card-front, .flip-card-back { box-shadow: 0 8px 14px 0 rgba(0,0,0,.2); position: absolute; display: flex; flex-direction: column; justify-content: center; width: 100%; height: 100%; backface-visibility: hidden; border-radius: 1rem; }
  .flip-card-front { box-shadow: rgba(0,0,0,.4) 0 2px 2px, rgba(0,0,0,.3) 0 7px 13px -3px, rgba(0,0,0,.2) 0 -1px 0 inset; background-color: #171717; }
  .flip-card-back { box-shadow: rgba(0,0,0,.4) 0 2px 2px, rgba(0,0,0,.3) 0 7px 13px -3px, rgba(0,0,0,.2) 0 -1px 0 inset; background-color: #171717; transform: rotateY(180deg); }
`;
