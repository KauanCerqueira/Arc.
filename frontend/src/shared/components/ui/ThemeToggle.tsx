...
export default function ThemeToggle() {
  ...
  return (
    <label
      className="theme-toggle-button cursor-pointer inline-flex items-center flex-shrink-0"
    ...
    >
      ...
      >
        <defs>
          ...
          <filter id="moon-shadow" x="-50%" y="-50%" width="200%" height="200%">
        ...
        <g transform="translate(3.5 3.5)">
          ...
          <g filter="url(#container-shadow)" transform="matrix(1, 0, 0, 1, -3.5, -3.5)">
            <rect
          ...
          {/* Button circle with sun/moon */}
          <g transform="translate(2.333 2.333)" className="theme-button">
            {/* Sun */}
            <g className="theme-sun">
              <g filter="url(#sun-shadow)" transform="matrix(1, 0, 0, 1, -5.83, -5.83)">
            ...
            {/* Moon */}
            <g className="theme-moon">
              <g filter="url(#moon-shadow)" transform="matrix(1, 0, 0, 1, -31.5, -5.83)">
          ...
          {/* Cloud */}
          <g filter="url(#cloud-shadow)" transform="matrix(1, 0, 0, 1, -3.5, -3.5)" className="theme-cloud">
            <path
              fill="#fff"
          ...
          {/* Stars */}
          <g fill="#def8ff" transform="translate(3.585 1.325)" className="theme-stars">
